  ...
  <div class="withdrawal-application">
    ...
    <div class="content-box">
      ...
      <div class="withdrawal-desc" v-if="!isRed">
        ...
        <br />
        5、提现永久有效 -->
        1、 支付宝账号与身份信息不一致将无法提现，请正确填写支付宝账号信息；
        <br />
        2、每个用户只能绑定1个支付宝账号进行提现，提现成功后不支持修改绑定账号，请谨慎操作；
        <br />
        3、前3次每次提现需≥0.13元，之后需要≥3元且为整数方可提现，例如3元、4元、5元....；
        <br />
        4、约购APP平台将按照国家税收规定代缴纳20%的偶然所得税，从用户提现金额中扣除；
        <br />
        5、用户提现资格长期有效；
      </div>
